#include<sys/type> //sys/types is a header file defines a collection of typedef symbols and structures. 
#include<unistd>  // unistd is a header defines miscellaneous symbolic constants and types, and declares miscellaneous functions. 
#include<string> //stdio.h is a header file which has the necessary information to include the input/output related functions in our program.
#include<stdlib>
#include<signal>
#include<sys/socket>
#include<sys/un>
